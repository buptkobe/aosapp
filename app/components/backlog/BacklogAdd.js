...
const styles = StyleSheet.create({
    container: {
	    ...
	    alignItems: 'center',
	    marginLeft: Util.size.width/2-120,
  	},
});

class BacklogAdd extends Component {
	render() {
	    return (
	      <ExNavigator
  			...
  			renderTitle() {
  				return (
  					<View style={styles.container}>
  						<Text style={{textAlign:'center'}}>新增backlog</Text>
  					</View>
				);
  			},
		          ...
		          >
		            ...
		            >
		              ...
		              <GiftedForm.SelectWidget name='gender' title='Gender' multiple={false}>
		                <GiftedForm.OptionWidget image={<Icon name="user"/>} title='Female' value='F'/>
		                <GiftedForm.OptionWidget image={<Icon name="user"/>} title='Male' value='M'/>
