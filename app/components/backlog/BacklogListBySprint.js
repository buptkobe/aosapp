...
import { queryBySprint } from '../../actions/backlogActions';
...
class BacklogListBySprint extends Component {

  _onFetch(page = 1, callback, options) {
    
	const sprintid = this.props.sprintid;
	this.props.queryBySprint(sprintid);
	setTimeout(() => {
...
export default connect(mapStateToProps, actions)(BacklogListBySprint);